...
export function TeamIdLoginScreen({
  ...
  return <View style={{
    ...
    <TextInput value={input} onChangeText={setInput} placeholder="e.g. 1234567" placeholderTextColor={colors.text.secondary} keyboardType="number-pad" style={{
    ...
    <Pressable onPress={handleSubmit} disabled={loading} style={{
      ...
      {loading ? <ActivityIndicator color={colors.bg.primary} /> : <Text style={{
